// NOTE: This is the server-side copy of the markdown library.
// src/lib/markdown.js is the frontend copy (used by Vite + React).
// Keep both in sync. The differences: this file omits chartRoots/getChartData
// (browser-only) but should otherwise be functionally identical.
...
export function extractDescription(markdown) {
  ...
  // Use [\s\S]*? so multi-line paragraph content is captured correctly
